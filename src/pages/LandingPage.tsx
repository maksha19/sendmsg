            ...
            <section className="bg-gradient-to-r from-blue-500 to-purple-500 text-white text-center p-6">
                <div className='flex  items-center justify-center'>
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='flex -mt-40 items-center z-10 h-[100px]'>
                            <svg
                                ...
                                height="100"
                            >
                                <circle cx="63" cy="90" r="8" fill="none" stroke="#FFF" strokeWidth="6">
                                    <animate
                                        attributeName="cy"
                                ...
                                <circle cx="95" cy="90" r="12" fill="none" stroke="#FFF" strokeWidth="8">
                                    <animate
                                        attributeName="cy"
                                        values="90;85;90;95;90"
                                        keyTimes="0;0.25;0.5;0.75;1"
                                ...
                                <circle cx="135" cy="90" r="16" fill="none" stroke="#FFF" strokeWidth="8">
                                    <animate
                                        attributeName="cy"
                                        values="90;85;90;95;90"
                                        keyTimes="0;0.25;0.5;0.75;1"
